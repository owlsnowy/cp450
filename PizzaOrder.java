   ...
   public static void main (String[] args)
   {
	  ...
	  if (inches == 10){
		 ...
		 cost = 14.99;
		  ...
		  System.out.println("your choice was not one of the choices, so a 12 inch pizza will be made.");
	  }
	  ...
	  switch (input.toLowerCase()) {
            case "h":  crust = "Hand-tossed";
						System.out.println("You have selected "+crust);
                     break;
            ...
            default:  crust = "Hand-tossed";
						System.out.println("Your selection was not a choice so a Hand-tossed crust will be made");
                     break;
	  }
